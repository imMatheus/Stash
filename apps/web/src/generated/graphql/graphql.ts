...
export type CreateStoreMutationMutation = {
  createStore: { id: string; name: string; productsCount: number };
};

export type MyStoresQueryVariables = Exact<{ [key: string]: never }>;

export type MyStoresQuery = {
  myStores: Array<{ id: string; name: string; productsCount: number }>;
};
...
export type StoreByIdQuery = {
  store?: { id: string; name: string; productsCount: number } | null;
};
...
export const CreateStoreMutationDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateStoreMutation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateStoreInput" },
            },
          },
        },
      ],
  ...
  CreateStoreMutationMutation,
  CreateStoreMutationMutationVariables
>;
...
export const StoreByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "StoreById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<StoreByIdQuery, StoreByIdQueryVariables>;
