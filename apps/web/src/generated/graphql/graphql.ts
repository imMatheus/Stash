...
export type StoreByIdQuery = { store?: { id: string, name: string, productsCount: number, createdAt: any, members: Array<{ id: string, userId: string, user: { id: string, profileImage: string, username?: string | null } }> } | null };
