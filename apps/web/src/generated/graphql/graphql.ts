...
export type StoreByIdQuery = { store?: { id: string, name: string, productsCount: number, createdAt: any, members: Array<{ id: string, userId: string, role: StoreMemberRole, createdAt: any, user: { id: string, profileImage: string, username?: string | null, account: { id: string, email: string } } }> } | null };
